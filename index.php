...
<footer class="footer mt-auto py-3">
  ...
  <div class="container">
      <span class="text-muted">
        &copy; Copyright, 1970-<?php echo date('Y'); ?>, &nbsp;Компания Топ. Все права защищены.
      </span>
  </div>
...
function click() {
    ...
    let href = 'https://какой-то-адрес.ру/fran/hs/mail/subscribe?' + Email;
...
function Unsubscribe() {
      ...
      if (ids.length > 0) {
        const Email = document.location.href.split('?')[1];
        const url='https://какой-то-адрес.ру/fran/hs/mail/unsubscribe?' + Email + '&id=' + ids.substring(0, ids.length - 1);
